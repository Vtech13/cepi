...
class MessageController extends Controller { 
    ...
    public function index()
    {
        ...
        return view('platform.user.messages.index', compact('groups', 'confreres'));
    }
    ...
    public function show(Group $group)
    {
        ...
        return view('platform.user.messages.show', compact('group', 'messages', 'pusherKey', 'pusherCluster', 'groupId'));
    }
